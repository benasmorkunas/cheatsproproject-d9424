            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <input
                  ...
                  className="w-full px-3 py-2 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
                />
              </div>
              <div>
                <input
        ...
        {(filters.search || filters.minPrice || filters.maxPrice || filters.onSale || filters.inStock || filters.featured) && (
          <div className="mt-6 pt-6 border-t border-gray-700/50">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {filters.inStock && (
                <div className="bg-blue-600/20 border border-blue-500/30 rounded-full px-2 py-1 text-xs text-blue-300">
                  In Stock
                </div>
              )}
              {filters.featured && (
